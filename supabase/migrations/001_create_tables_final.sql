-- Миграция: Создание таблиц organizations и school_details (финальная версия)
-- Дата: 2025-12-12
...
CREATE TABLE organizations (
  ...
  org_type TEXT NOT NULL CHECK (
    org_type IN ('school', 'university', 'kindergarten', 'center', 'course')
  ),
  name TEXT NOT NULL,
...
CREATE TABLE school_details (
  ...
  school_type TEXT NOT NULL CHECK (
    school_type IN ('private', 'state', 'international')
  ),
  ...
  -- Table-level constraints для сравнения столбцов
