  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        <div 
          className={cn(
            'max-w-[1440px] mx-auto px-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 lg:gap-0 transition-[padding] duration-300 ease-out',
